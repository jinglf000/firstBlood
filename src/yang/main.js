/**
 * @author jinglf000
 * @description 个人中心 入口文件
 */


require.config({
	baseUrl: '../assest/js/lib',
	paths: {
		'jquery': 'jquery.min',
		'artTemplate': 'template-web',
		'validate': 'jquery.validate',
		'base': '/assest/js/base',
		'tools': '/assest/js/tools'
	}
});
require(['jquery', 'artTemplate', 'validate', 'base', 'tools'], function ($, template, a, config, t) {
	$(function () {
		/**
		 * 简历各项内容操作
		...
		// 编辑框渲染成功
		base.con.on('editSucc', function (event) {
